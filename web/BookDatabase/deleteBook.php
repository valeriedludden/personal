...
<div class="deleteContainer">
    ...
    <div>
        <form method="POST">
            <label class="addTitle" for="delete-title">Title of Book to Delete:</label>
            <input type="text" id="add-title" name="delete-title" placeholder="Book Title"><br/>
            <input type="submit" value="Delete Book"> <br/>
        </form>
    </div>
</div>

<?php $book = strtoupper($_POST["book"]);
